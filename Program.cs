...
namespace ComputerStore{
    public class MyComputer{
        public static void Main(string[] args){
            string connectionString = "Server=localhost;Database=<Your Database Name>;Trusted_Connection=false;TrustServerCertificate=true;User Id=<Your User>;Password=<Your Password>;"; 
